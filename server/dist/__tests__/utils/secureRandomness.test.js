...
describe('secureRandomness utilities', () => {
    describe('secureRandomString', () => {
        it('should generate string of correct length', () => {
            ...
            lengths.forEach(length => {
                const result = (0, secureRandomness_1.secureRandomString)(length);
                expect(result).toHaveLength(length);
            });
        });
        it('should generate different strings on each call', () => {
            const string1 = (0, secureRandomness_1.secureRandomString)(16);
            const string2 = (0, secureRandomness_1.secureRandomString)(16);
            const string3 = (0, secureRandomness_1.secureRandomString)(16);
        ...
        it('should only contain valid charset characters', () => {
            ...
            const result = (0, secureRandomness_1.secureRandomString)(100);
        ...
        it('should handle edge cases', () => {
            // Test with length 0
            const emptyString = (0, secureRandomness_1.secureRandomString)(0);
            expect(emptyString).toBe('');
            // Test with length 1
            const singleChar = (0, secureRandomness_1.secureRandomString)(1);
        ...
        it('should be cryptographically random', () => {
            ...
            for (let i = 0; i < iterations; i++) {
                results.push((0, secureRandomness_1.secureRandomString)(testLength));
            }
    ...
    describe('generateSecureSeed', () => {
        it('should generate hex string of correct length', () => {
            ...
            byteLengths.forEach(byteLength => {
                const result = (0, secureRandomness_1.generateSecureSeed)(byteLength);
        ...
        it('should generate valid hexadecimal strings', () => {
            const result = (0, secureRandomness_1.generateSecureSeed)(32);
            const hexPattern = /^[0-9a-f]+$/;
            expect(hexPattern.test(result)).toBe(true);
        });
        it('should generate different seeds on each call', () => {
            const seed1 = (0, secureRandomness_1.generateSecureSeed)(32);
            const seed2 = (0, secureRandomness_1.generateSecureSeed)(32);
            const seed3 = (0, secureRandomness_1.generateSecureSeed)(32);
        ...
        it('should handle different byte lengths', () => {
            ...
            lengths.forEach(length => {
                const result = (0, secureRandomness_1.generateSecureSeed)(length);
        ...
        it('should handle edge cases', () => {
            // Test with 0 bytes
            const emptyResult = (0, secureRandomness_1.generateSecureSeed)(0);
            expect(emptyResult).toBe('');
            // Test with 1 byte
            const singleByte = (0, secureRandomness_1.generateSecureSeed)(1);
        ...
        it('should be cryptographically random', () => {
            ...
            const seedLength = 16;
            for (let i = 0; i < iterations; i++) {
                results.push((0, secureRandomness_1.generateSecureSeed)(seedLength));
            }
    ...
    describe('createServerSeedHash', () => {
        it('should create SHA256 hash of correct length', () => {
            ...
            testSeeds.forEach(seed => {
                const hash = (0, secureRandomness_1.createServerSeedHash)(seed);
        ...
        it('should be deterministic', () => {
            ...
            const hash1 = (0, secureRandomness_1.createServerSeedHash)(testSeed);
            const hash2 = (0, secureRandomness_1.createServerSeedHash)(testSeed);
            const hash3 = (0, secureRandomness_1.createServerSeedHash)(testSeed);
        ...
        it('should produce different hashes for different inputs', () => {
            ...
            const hash1 = (0, secureRandomness_1.createServerSeedHash)(seed1);
            const hash2 = (0, secureRandomness_1.createServerSeedHash)(seed2);
            const hash3 = (0, secureRandomness_1.createServerSeedHash)(seed3);
            expect(hash1).not.toBe(hash2);
            expect(hash2).not.toBe(hash3);
            expect(hash1).not.toBe(hash3);
        });
        it('should handle empty string', () => {
            const hash = (0, secureRandomness_1.createServerSeedHash)('');
            expect(hash).toHaveLength(64);
            expect(/^[0-9a-f]{64}$/.test(hash)).toBe(true);
        ...
        it('should be suitable for cryptographic use cases', () => {
            ...
            const hashes = testSeeds.map(seed => (0, secureRandomness_1.createServerSeedHash)(seed));
        ...
        it('should handle very long inputs', () => {
            ...
            const hash = (0, secureRandomness_1.createServerSeedHash)(longSeed);
            expect(hash).toHaveLength(64);
            expect(/^[0-9a-f]{64}$/.test(hash)).toBe(true);
        });
        it('should be consistent with known test vectors', () => {
            ...
            testCases.forEach(testCase => {
                const result1 = (0, secureRandomness_1.createServerSeedHash)(testCase.input);
                const result2 = (0, secureRandomness_1.createServerSeedHash)(testCase.input);
    ...
    describe('Integration tests', () => {
        it('should work together for gaming use case', () => {
            ...
            const serverSeed = (0, secureRandomness_1.generateSecureSeed)(32);
            const clientSeed = (0, secureRandomness_1.secureRandomString)(16);
            const serverSeedHash = (0, secureRandomness_1.createServerSeedHash)(serverSeed);
            ...
            const secondHash = (0, secureRandomness_1.createServerSeedHash)(serverSeed);
        ...
        it('should provide sufficient entropy for gaming', () => {
            ...
            for (let i = 0; i < 100; i++) {
                sessions.push({
                    ...
                    clientSeed: (0, secureRandomness_1.secureRandomString)(16),
                    sessionId: (0, secureRandomness_1.secureRandomString)(24)
                });
            }
            ...
            sessions.forEach(session => {
                const hash1 = (0, secureRandomness_1.createServerSeedHash)(session.serverSeed);
                const hash2 = (0, secureRandomness_1.createServerSeedHash)(session.serverSeed);
                expect(hash1).toBe(hash2);
            });
        });
    });
